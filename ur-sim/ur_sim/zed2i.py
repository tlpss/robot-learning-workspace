...
class Zed2i:
    ...
    def __init__(self, eye_position, resolution="HD1080", target_position=None):
        self.focal_length_in_pixels = 1000
        self.image_size = (1920, 1080)  # wxh
        ...
        self.view_matrix = p.computeViewMatrix(self.eye_position, self.target_position, up_dir)
